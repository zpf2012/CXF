 ...
 * generated in the com.spring.cxf.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://ws.cxf.spring.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://ws.cxf.spring.com/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.spring.cxf.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.spring.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cxf.spring.com/", name = "getOrderByIdResponse")
