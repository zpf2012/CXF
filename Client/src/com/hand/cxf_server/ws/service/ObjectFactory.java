 ...
 * generated in the com.hand.cxf_server.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://service.ws.cxf_server.hand.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://service.ws.cxf_server.hand.com/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hand.cxf_server.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.cxf_server.hand.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.cxf_server.hand.com/", name = "getOrderByIdResponse")
